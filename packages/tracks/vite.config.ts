...
export default defineConfig({
  test: {
    alias: {
      ...
      "@weng-lab/genomebrowser-tracks/bam": path.resolve(__dirname, "src/bam/index.ts"),
      ...
      "@weng-lab/genomebrowser-tracks/dynseq": path.resolve(__dirname, "src/dynseq/index.ts"),
