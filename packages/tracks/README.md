...
First-party track modules for `@weng-lab/genomebrowser`. The package includes BAM, BigBed, cCRE BigBed, BigWig, BulkBed, CAVE, dynseq, Gene, and MethylC modules. Each one provides its data fetcher, renderer, MUI settings, and SVG tooltip.
